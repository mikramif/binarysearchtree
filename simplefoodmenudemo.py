...
if readme:
    ...
    st.write("""
        This is a simple binary search tree demo using [streamlit](https://streamlit.io/) library. It is hosted on [heroku](https://www.heroku.com/). You may get the codes via [github](https://github.com/mikramif/binarysearchtree)
        """)

    st.write ("For more info, please contact:")

    st.write("<a href='mikramif@gmail.com'>Ikram </a>", unsafe_allow_html=True)

st.write("Choose an option from the drop down menu on the side bar to continue.")
